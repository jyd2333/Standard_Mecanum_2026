            ...
            if (Verify_CRC16_Check_Sum(buff, judge_length) == TRUE) {
                ...
                switch (referee_info.CmdID) {
                    ...
                    case ID_event_data: // 0x0101
                        ...
                        break;
                    case ID_referee_warning://0x104
                        memcpy(&referee_info.referee_warning, (buff + DATA_Offset), LEN_REF_warning);
                        break;
                    ...
                    case ID_projectile_allowance: // 0x0208
                        ...
                        break;
                    case ID_RFID_state: // 0x0209
                        memcpy(&referee_info.RFID_state, (buff + DATA_Offset), LEN_RFID_state);
                        break;
